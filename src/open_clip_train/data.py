...
def get_wds_dataset(args, preprocess_img, is_train, epoch=0, floor=False, tokenizer=None):
    # provide path to the file with url string
    with open(args.train_data, "r") as url_file:
        urls = url_file.read().strip()

    input_shards = urls if is_train else args.val_data
